...
The implementation backlog is tracked in [GitHub Issues](https://github.com/d6e-ai/signkit/issues), including DOCX conversion, agent workload credentials and a Rust CLI, enterprise SSO/audit export boundaries, a documented but unimplemented recipient capability reissue design (see [docs/design.md](docs/design.md)), and the lower-priority Vercel production profile.
