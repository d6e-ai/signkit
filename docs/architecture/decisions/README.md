...
- [2026-09-17-instance-member-identity-snapshots.md](./2026-09-17-instance-member-identity-snapshots.md) — member lists use display-only name/email snapshots from each user's own verified d6e-auth principal; subject, role, and status remain the authorization inputs.
