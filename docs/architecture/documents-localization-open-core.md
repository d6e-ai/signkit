...
Status: mixed — localization, bounded DOCX import/export, executed agreement PDF composition, optional instance PAdES B-B/B-T sealing, authenticated download, operator UI, and CLI are implemented; the open-core boundary is policy
