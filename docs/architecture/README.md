...
| [agent-contract.md](agent-contract.md)                                                       | Agent/CLI command contract                                                                                | implemented — CLI reads and authoring/send/DOCX mutations, served OpenAPI 3.1, signed retryable webhooks                      |
