...
- **Canonical Contracts:** Consult `docs/api.md` and `docs/design.md` in this repository for normative contracts. Never invent unexposed endpoints, webhooks, or write scopes.
